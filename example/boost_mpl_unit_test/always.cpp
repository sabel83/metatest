...
namespace
{
  const metatest::suite_path suite ("always");
...
METATEST_ADD_TEST(suite, test_apply_f)
METATEST_ADD_TEST(suite, test_apply_f_f)
METATEST_ADD_TEST(suite, test_apply_f_f_f)

METATEST_ADD_TEST(suite, test_apply_0)
METATEST_ADD_TEST(suite, test_apply_0_0)
METATEST_ADD_TEST(suite, test_apply_0_0_0)
