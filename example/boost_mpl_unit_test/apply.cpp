...
namespace
{
  const metatest::suite_path suite ("apply");
...
METATEST_ADD_TEST(suite, test12)
METATEST_ADD_TEST(suite, test13)
METATEST_ADD_TEST(suite, test14)
#if !BOOST_WORKAROUND(__MWERKS__, BOOST_TESTED_AT(0x3003))
METATEST_ADD_TEST(suite, test15)
#endif
METATEST_ADD_TEST(suite, test16)
METATEST_ADD_TEST(suite, test17)
