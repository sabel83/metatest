...
namespace
{
  const metatest::suite_path suite ("arithmetic");
...
METATEST_ADD_TEST(suite, test_0_plus_10)
METATEST_ADD_TEST(suite, test_10_plus_0)
METATEST_ADD_TEST(suite, test_0_minus_10)
METATEST_ADD_TEST(suite, test_10_minus_0)
METATEST_ADD_TEST(suite, test_1_times_10)
METATEST_ADD_TEST(suite, test_10_times_1)
METATEST_ADD_TEST(suite, test_1_mult_10)
METATEST_ADD_TEST(suite, test_10_mult_1)
METATEST_ADD_TEST(suite, test_10_div_1)
METATEST_ADD_TEST(suite, test_10_mod_1)
METATEST_ADD_TEST(suite, test_10_mod_3)
#if !defined(BOOST_NO_TEMPLATE_PARTIAL_SPECIALIZATION)
METATEST_ADD_TEST(suite, test_10_minus_1_minus_10)
METATEST_ADD_TEST(suite, test_10_plus_1_plus_10)
METATEST_ADD_TEST(suite, test_10_div_1_div_10)
#endif
METATEST_ADD_TEST(suite, test_negate_10)
