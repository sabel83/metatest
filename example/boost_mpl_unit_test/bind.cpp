...
namespace
{
  const metatest::suite_path suite ("bind");
  ...
  namespace testcase_1
  {
    ...
    METATEST_ADD_TEST(suite, basic1)
    METATEST_ADD_TEST(suite, basic2)
    METATEST_ADD_TEST(suite, basic3)
    METATEST_ADD_TEST(suite, basic4)
  }
  ...
  namespace testcase_2
  {
    ...
    METATEST_ADD_TEST(suite, full1)
    METATEST_ADD_TEST(suite, full2)
  }
  ...
  namespace testcase_3
  {
    ...
    METATEST_ADD_TEST(suite, composition1)
    METATEST_ADD_TEST(suite, composition2)
  }
...
//    && BOOST_WORKAROUND(__MWERKS__, BOOST_TESTED_AT(0x3003))
  namespace testcase_4
  {
    ...
    METATEST_ADD_TEST(suite, if1)
    METATEST_ADD_TEST(suite, if2)
  }
//#endif
}
