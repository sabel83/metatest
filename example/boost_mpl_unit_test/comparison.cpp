...
namespace
{
  const metatest::suite_path suite ("comparison");
...
METATEST_ADD_TEST(suite, test_equal_to_1)
METATEST_ADD_TEST(suite, test_equal_to_2)
METATEST_ADD_TEST(suite, test_equal_to_3)

METATEST_ADD_TEST(suite, test_not_equal_to_1)
METATEST_ADD_TEST(suite, test_not_equal_to_2)
METATEST_ADD_TEST(suite, test_not_equal_to_3)

METATEST_ADD_TEST(suite, test_less_1)
METATEST_ADD_TEST(suite, test_less_2)
METATEST_ADD_TEST(suite, test_less_3)

METATEST_ADD_TEST(suite, test_less_equal_1)
METATEST_ADD_TEST(suite, test_less_equal_2)
METATEST_ADD_TEST(suite, test_less_equal_3)

METATEST_ADD_TEST(suite, test_greater_1)
METATEST_ADD_TEST(suite, test_greater_2)
METATEST_ADD_TEST(suite, test_greater_3)

METATEST_ADD_TEST(suite, test_greater_equal_1)
METATEST_ADD_TEST(suite, test_greater_equal_2)
METATEST_ADD_TEST(suite, test_greater_equal_3)
