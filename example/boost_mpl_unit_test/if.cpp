...
namespace
{
  const metatest::suite_path suite ("if");
...
METATEST_ADD_TEST (suite, test_if_true)
METATEST_ADD_TEST (suite, test_if_c_true)
METATEST_ADD_TEST (suite, test_if_false)
METATEST_ADD_TEST (suite, test_if_c_false)
