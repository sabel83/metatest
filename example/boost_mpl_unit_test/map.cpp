...
namespace
{
  const metatest::suite_path suite ("map");
  ...
  namespace testcase_1
  {
    ...
    METATEST_ADD_TEST(suite, test_erase_1)
    METATEST_ADD_TEST(suite, test_erase_2)
    METATEST_ADD_TEST(suite, test_clear_1)
    METATEST_ADD_TEST(suite, test_at_1)
    METATEST_ADD_TEST(suite, test_at_2)
    METATEST_ADD_TEST(suite, test_contains_1)
    METATEST_ADD_TEST(suite, test_contains_2)
    METATEST_ADD_TEST(suite, test_contains_3)
    METATEST_ADD_TEST(suite, test_has_key_1)
    METATEST_ADD_TEST(suite, test_has_key_2)
    METATEST_ADD_TEST(suite, test_order_1)
    METATEST_ADD_TEST(suite, test_order_2)
    METATEST_ADD_TEST(suite, test_deref_1)
    METATEST_ADD_TEST(suite, test_next_1)
    METATEST_ADD_TEST(suite, test_size_1)
    METATEST_ADD_TEST(suite, test_empty_1)
    METATEST_ADD_TEST(suite, test_clear_2)
    METATEST_ADD_TEST(suite, test_at_3)
    METATEST_ADD_TEST(suite, test_at_4)
    METATEST_ADD_TEST(suite, test_contains_4)
    METATEST_ADD_TEST(suite, test_contains_5)
    METATEST_ADD_TEST(suite, test_contains_6)
    METATEST_ADD_TEST(suite, test_contains_7)
    METATEST_ADD_TEST(suite, test_has_key_3)
    METATEST_ADD_TEST(suite, test_has_key_4)
    METATEST_ADD_TEST(suite, test_order_3)
    METATEST_ADD_TEST(suite, test_order_4)
    METATEST_ADD_TEST(suite, test_order_5)
    METATEST_ADD_TEST(suite, test_deref_2)
    METATEST_ADD_TEST(suite, test_deref_3)
    METATEST_ADD_TEST(suite, test_next_2)
    METATEST_ADD_TEST(suite, test_insert_1)
    METATEST_ADD_TEST(suite, test_size_2)
    METATEST_ADD_TEST(suite, test_has_key_5)
    METATEST_ADD_TEST(suite, test_has_key_6)
    METATEST_ADD_TEST(suite, test_has_key_7)
    METATEST_ADD_TEST(suite, test_contains_8)
    METATEST_ADD_TEST(suite, test_contains_9)
    METATEST_ADD_TEST(suite, test_size_3)
    METATEST_ADD_TEST(suite, test_at_5)
    METATEST_ADD_TEST(suite, test_at_6)
    METATEST_ADD_TEST(suite, test_contains_10)
    METATEST_ADD_TEST(suite, test_contains_11)
    METATEST_ADD_TEST(suite, test_contains_12)
    METATEST_ADD_TEST(suite, test_contains_13)
    METATEST_ADD_TEST(suite, test_insert_2)
    METATEST_ADD_TEST(suite, test_erase_key_1)
    METATEST_ADD_TEST(suite, test_size_4)
    METATEST_ADD_TEST(suite, test_at_7)
    METATEST_ADD_TEST(suite, test_at_8)
    METATEST_ADD_TEST(suite, test_size_5)
    METATEST_ADD_TEST(suite, test_at_9)
    METATEST_ADD_TEST(suite, test_at_10)
    METATEST_ADD_TEST(suite, test_at_11)
  }
  ...
  namespace testcase_2
  {
    ...
    METATEST_ADD_TEST(suite, test_has_key_6)
    METATEST_ADD_TEST(suite, test_has_key_7)
    METATEST_ADD_TEST(suite, test_has_key_8)
    METATEST_ADD_TEST(suite, test_has_key_9)
    METATEST_ADD_TEST(suite, test_has_key_10)
    METATEST_ADD_TEST(suite, test_has_key_11)
    METATEST_ADD_TEST(suite, test_has_key_12)
    METATEST_ADD_TEST(suite, test_has_key_13)
    METATEST_ADD_TEST(suite, test_has_key_14)
    METATEST_ADD_TEST(suite, test_size_2)
    METATEST_ADD_TEST(suite, test_at_2)
    METATEST_ADD_TEST(suite, test_size_3)
    METATEST_ADD_TEST(suite, test_at_3)
  ...
  namespace testcase_3
  {
    ...
    METATEST_ADD_TEST(suite, test_deref)
    METATEST_ADD_TEST(suite, test_size)
    METATEST_ADD_TEST(suite, test_find_1)
    METATEST_ADD_TEST(suite, test_find_2)
    METATEST_ADD_TEST(suite, test_find_3)
    METATEST_ADD_TEST(suite, test_find_4)
  }
  ...
  namespace testcase_4
  {
    ...
    METATEST_ADD_TEST(suite, test_at)
  }
}
