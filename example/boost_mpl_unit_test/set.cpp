...
namespace
{
  const metatest::suite_path suite ("set");
  ...
  namespace testcase_1
  {
    ...
    METATEST_ADD_TEST(suite, test_num_var_1)
    METATEST_ADD_TEST(suite, test_num_var_2)
    METATEST_ADD_TEST(suite, test_num_var_3)
    METATEST_ADD_TEST(suite, test_num_var_4)
    METATEST_ADD_TEST(suite, test_basic_1)
    METATEST_ADD_TEST(suite, test_basic_2)
    METATEST_ADD_TEST(suite, test_basic_3)
    METATEST_ADD_TEST(suite, test_basic_4)
    METATEST_ADD_TEST(suite, test_basic_5)
  }
  ...
  namespace testcase_2
  {
    ...
    METATEST_ADD_TEST(suite, test_empty_types_1)
    METATEST_ADD_TEST(suite, test_empty_types_2)
    METATEST_ADD_TEST(suite, test_types_1)
    METATEST_ADD_TEST(suite, test_types_2)
  }
