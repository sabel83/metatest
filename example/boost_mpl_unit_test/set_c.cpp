...
namespace
{
  const metatest::suite_path suite ("set_c");
  ...
  namespace testcase_1
  {
    ...
    METATEST_ADD_TEST(suite, test_value_type_1)
    METATEST_ADD_TEST(suite, test_value_type_2)
...
#endif
    //METATEST_ADD_TEST(suite, test_iterator_1)
    //METATEST_ADD_TEST(suite, test_iterator_2)
    //METATEST_ADD_TEST(suite, test_iterator_3)
  }
#endif
