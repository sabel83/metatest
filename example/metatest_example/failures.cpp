...
METATEST_ADD_TEST(suite, test_no_type)
METATEST_ADD_TEST(suite, test_no_type_value)
METATEST_ADD_TEST(suite, test_fail)
METATEST_ADD_TEST(suite, test_fail_with_to_equal)
METATEST_ADD_TEST(suite, test_fail_with_is_same)
METATEST_ADD_TEST(suite, test_fail_complex_expression)
