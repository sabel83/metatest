...
namespace
{
  const metatest::suite_path suite ("my_reverse");
...
METATEST_ADD_TEST(suite, empty_test_failing)
METATEST_ADD_TEST(suite, one_test_failing)
METATEST_ADD_TEST(suite, four_test_failing)
